...
public class Board : MonoBehaviour
{
    ...
    private void Update()
    {
        string translation = testScript.getLastTranslation();
        ...
        foreach (char characater in translation)
        {
            currentRow.tiles[columnIndex].SetLetter(characater);
            columnIndex++;
        }
